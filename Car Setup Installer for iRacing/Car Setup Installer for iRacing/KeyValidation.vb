...
'to add this to your code. Right click project name in Solution Explorer>Add>Module>CodeFile>. Copy&Paste this code into file. 
'use assign validation to textbox to add validation
' ex: AssignValidation(Me.txt_MotorRPMADJ_Pos0, ValidationType.Only_Numbers)
Module Module1
    ...
    Public Sub AssignValidation(ByRef CTRL As Windows.Forms.TextBox, ByVal Validation_Type As ValidationType)
        ...
        Select Case Validation_Type
            ...
            Case ValidationType.Only_Folder
                AddHandler txt.KeyPress, AddressOf Folder_Leave
        End Select
    End Sub
    ...
    Public Sub NotNull_Leave(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        End If
    End Sub
    Public Sub Folder_Leave(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs)
